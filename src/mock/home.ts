...
const MOCK_CONSULT_EXPERTS: ConsultExpertItem[] = [
  {
    ...
    good_rate: 90,
    service_count: 999,
    description: '专业塔罗分析，解答你的情感困惑与人生方向',
  ...
  },
  {
    ...
    good_rate: 95,
    service_count: 1200,
    description: '星盘合盘分析，帮你洞察关系中的潜在问题',
  ...
  },
  {
    ...
    good_rate: 92,
    service_count: 680,
    description: '情感塔罗解读，温柔陪伴你的每一个迷茫时刻',
    price_per_minute: 7.90,
    gender: '女',
    voice_duration: 15,
    badge: '优选',
  },
  {
    ...
    good_rate: 86,
    service_count: 450,
    description: '国学命理咨询，以传统智慧指引现代生活',
    price_per_minute: 6.80,
    gender: '男',
    voice_duration: 15,
  },
  {
    ...
    good_rate: 98,
    service_count: 1500,
    description: '深度塔罗牌阵分析，精准解读你的未来走向',
